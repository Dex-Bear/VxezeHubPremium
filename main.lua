...
ScreenGui.Name = "FluentButtonGui"
...
ImageButton.MouseButton1Up:Connect(UnhoverEffect)
ImageButton.MouseEnter:Connect(HoverEffect)
ImageButton.MouseLeave:Connect(UnhoverEffect)
